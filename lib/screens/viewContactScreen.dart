...
class _viewContactScreenState extends State<viewContactScreen> {
  ...
  void initState() {
    ...
    initialCameraPosition = const LatLng(37.7749, -122.4194); // Exemplo: São Francisco.
    locations = widget.contact.locations; // Inicializa com os marcadores do contato.
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: () async {Position position = await getCurrentLocation();
                  final newMarker = Marker(
                    markerId: MarkerId(DateTime.now().toString()),
                    position: LatLng(position.latitude, position.longitude),
                    infoWindow: InfoWindow(title: DateFormat('dd/MM/yyyy HH:mm').format(DateTime.now())),
                  );
